...
| GET   | /Pause      | metricNames<br/> offsetMin (опционально)  | Приостанавливает сбор метрик |
| GET   | /Continue   | metricNames                               | Возобновляет сбор метрик     |
| POST  | /set_config | file                                      | Устанавливает новый конфигурационный файл и применяет его в работу экспортера |
